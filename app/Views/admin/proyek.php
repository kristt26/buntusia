        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                    ...
                    <a href="" class="btn btn-outline-primary btn-sm" style="margin-bottom: 10px;margin-top: -17px;"
                        data-toggle="modal" data-target="#modelId" ng-click="removee()" data-backdrop="static"
                        ...
                        <tbody>
                            <tr ng-repeat="item in datas.proyek">
                                ...
                                <td>
                                    ...
                                    <a href="" ng-click="detail(item, 'Admin')" class="text-secondary"><i
                                            class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                        </tbody>
