...
<!-- Container Fluid-->
<div ng-controller="pegawaiController" class="ml-2 mr-2">
            ...
            <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                    ...
                    <a href="javascript:void()" class="btn btn-outline-primary btn-sm"
                        style="margin-bottom: 10px;margin-top: -17px;" data-toggle="modal" data-target="#modelId"
                        ng-click="removee()" data-backdrop="static" data-keyboard="false"><i class="fa fa-plus"></i>
                        Tambah</a>
